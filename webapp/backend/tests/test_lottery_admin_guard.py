...
ADMIN_ROUTES = {
    ...
    ("POST", "/lottery/{lottery_id}/vrf-binded"),
    ("POST", "/lottery/{lottery_id}/vrf-fulfilled"),
    ("POST", "/lottery/{lottery_id}/offchain-vrf"),
    ("POST", "/lottery/{lottery_id}/phase2-prepare"),
    ("POST", "/lottery/{lottery_id}/phase2-request-randomness"),
    ("POST", "/lottery/{lottery_id}/phase2-reveal"),
    ("GET", "/lottery/{lottery_id}/retry-randomness-check"),
